...
Clear-object detection, e.g. glass and transparent plastic, with depth cameras present challenges inherent to the physical properties such as opacity and consequently diffused and reflected light. As depth cameras rely on laser 
\lipsum[1]  
